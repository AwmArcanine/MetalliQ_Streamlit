...
# === ⚡ CYBER-GLASS THEME: ELECTRIC BLUE FUTURISTIC DASHBOARD ===
st.markdown("""
<style>
...
h1 {
    color: #4EF3FF !important;
    font-family: 'Orbitron', sans-serif !important;
    text-shadow: 0 0 15px rgba(78, 243, 255, 0.8);
...
.metriccard {
    ...
    box-shadow: 0 0 20px rgba(78, 243, 255, 0.15);
    text-align: center;
    padding: 20px 15px;
    color: #E6FFFF;
    margin-bottom: 25px;
...
def dashboard_page(workspace=None):
    ...
    if not results:
        ...
        results = {
            ...
            "reuse_projects": [("New Building Frame", "Steel", 90), ("Residential Building", "Steel", 85), ("Project Gamma", "Copper", 85)],
            "extended_circularity": [("Resource Efficiency", 92), ("Extended Product Life", 110), ("Reuse Potential", "40/50"),
                                     ("Material Recovery", 90), ("Closed-Loop Potential", 75), ("Recycling Content", 10),
                                     ("Landfill Rate", 8), ("Energy Recovery", 2)],
            "key_impact_profiles": [("GWP", 2293), ("Energy", 26454), ("Water", 4.7), ("Eutrophication", 1.15), ("Acidification", 4.10)],
            "summary": {
    ...
    pie_fig = go.Figure(go.Pie(labels=["Recycled Route", "Primary Route"], values=results["pie_share"],
                               hole=0.6, marker=dict(colors=["#00EFFF", "#024E5C"]),
    ...
    bar.update_layout(showlegend=False, height=300, font=dict(color="#E6FFFF"),
                      paper_bgcolor='rgba(255,255,255,0)', plot_bgcolor='rgba(255,255,255,0)')
