...
def login_page():
    ...
    .login-wrapper {
        ...
        align-items: center;
        height: 100vh;
        gap: 8px; /* 8px gap between card and buttons */
    }
    ...
    .login-title {
        ...
        font-weight: 700;
        color: #6FFFE9;
        text-shadow: 0 0 14px rgba(111, 255, 233, 0.9);
        margin-bottom: 5px;
    }
    ...
    /* Button container aligned with card width */
    .btn-container {
        display: flex;
        flex-direction: column;
        width: 380px;
    ...
    .stButton>button:last-child {
        ...
        box-shadow: 0 0 10px rgba(0,109,119,0.4);
    }
